          ...
          {stageApps.map(app => {
            ...
            return (
              ...
              >
                ...
                {(() => {
                  const score = typeof app.portfolio_score === 'string' ? parseInt(app.portfolio_score, 10) || 0 : app.portfolio_score || 0;
                  return score > 0 ? (
    ...
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16, flexShrink: 0 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <a href="/docs/junior-editor-flow" target="_blank" rel="noopener noreferrer" style={{ fontSize: 11, color: 'var(--accent)', textDecoration: 'none', padding: '3px 8px', borderRadius: 6, border: '1px solid var(--accent)', opacity: 0.8 }}>📋 Flow</a>
        </div>
